...
WebUI.click(findTestObject('Page_GitHub Where the world builds software  GitHub/a_Sign in'))

WebUI.setText(findTestObject('Object Repository/Page_Sign in to GitHub  GitHub/input_Username or email address_login'), 
    'rangga@flick.id')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Sign in to GitHub  GitHub/input_Password_password'), 'aeHFOx8jV/A=')
